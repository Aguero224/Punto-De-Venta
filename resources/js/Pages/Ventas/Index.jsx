...
export default function Index({ auth, ventas, clientes, productos }) {
    ...
    <tbody>
        {ventasList.map((v) => (
            ...
            <Modal
                title={form.id ? 'Editar Venta' : 'Registrar Venta'}
                isOpen={showModal}
                onClose={closeModal}
            >
                <form onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        {errors.cliente_id && (
                            <div className="text-red-600 text-sm">{errors.cliente_id}</div>
                        )}
                    </div>
                    ...
                    <div className="mb-4 border p-2">
                        ...
                        {errors.productos && (
                            <div className="text-red-600 text-sm">{errors.productos}</div>
                        )}
                    </div>
